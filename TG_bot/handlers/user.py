...
from utils.calendar import AppointmentCalendar
...
async def process_time_selection(callback: CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        # maxsplit=2 означает, что будет максимум 2 разбиения, итого 3 части
...
async def confirm_appointment(callback: CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        if success:
            ...
            new_appointment = next((a for a in appointments if a['time'] == data['selected_time']), None)
